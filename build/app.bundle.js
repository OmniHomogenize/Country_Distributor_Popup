...
(function ($) {
  ...
  function CreateCountryDropdown() {
    var countryAPI = "js/countries.json",
    ...
    this.init = function () {
      ...
      var lsCountry = localStorage.getItem('country');
      var lsDistrbiutor = localStorage.getItem('distributor');
      ...
      if (!created) {
        ...
        if (!countriesLoaded) {
          this.getCountriesArray().then(function (countries) {
            countriesArray = countries;
            _this.popup = $($.fancybox.getInstance().current.src)[0];

            _this.startDropdown(countries);
    ...
    this.startDropdown = function (countryArr) {
      ...
      ccd.cdsFormInput.autocomplete({
        ...
        lookup: function lookup(query, done) {
          var result = {
            suggestions: countryArr
          };
          var matcher = new RegExp("^" + query, "i");
          var sugest = $.map(result.suggestions, function (item) {
        ...
        onSelect: function onSelect(suggestion) {
          var country = self.capitalize(suggestion.value);
    ...
    this.findCountryCode = function (country) {
      ...
      for (var i = 0; i < countryCompleteArray.length; i++) {
    ...
    this.getCountries = function () {
      var self = this;
      var loadingMsg = 'Loading distributor countries';
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          $.getJSON(countryAPI, {
            ...
            var countryArray = $.map(result, function (country) {
              var newOb = {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          $.getJSON(distributorAPI, {
            ...
            var distributorArray = $.map(data, function (val, i) {
    ...
    this.unableToLoad = function (hideSearch, msg) {
      var message = 'Currently unable to load distributors, please check your internet connection or contact sales.';
    ...
    this.loadingIcon = function (boolean, msg) {
      if (boolean) {
        ...
        var loadingGif = 'http://www.nerdycoder.com/travis/spinner.gif';
    ...
    this.loadDistributors = function (country) {
      ...
      var self = this;
      var loadingMsg = 'Loading distributors for ' + selectedCountry;
      this.loadingIcon(true, loadingMsg);

      if (!countriesLoaded) {
        this.getDistributorsArray(country).then(function (distributors) {
          if (distributors.length >= 1) {
            self.animateForm(true);
            self.loadingIcon(false);
            return distributors;
          } else {
            _this2.callMessage('No distributors in this country');

            _this2.loadingIcon(false);
          }
        }).then(function (distributors) {
          setTimeout(function () {
            var distributorList = self.parseDistributors(distributors);
  ...
  ccd.distributorSection.on('click', '.distributor', function () {
    var distributorSelected = $(this)[0].childNodes[0].innerText;
  ...
  ccd.ldButton.on('click', function (e, countryCode) {
    ...
    if (countryCode != null) {
      ...
      var value = $(this)[0].form.elements[0].value;
      var newCountryCode = ccd.newCountryDropDown.findCountryCode(value);
...
/***/ 0:
/*!*****************************************!*\
  !*** multi babel-polyfill ./js/app2.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./js/app2.js */"./js/app2.js");
